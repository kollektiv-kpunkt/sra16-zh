...
/* harmony import */ var scroll_into_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! scroll-into-view */ "./node_modules/scroll-into-view/scrollIntoView.js");
/* harmony import */ var scroll_into_view__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(scroll_into_view__WEBPACK_IMPORTED_MODULE_5__);
...
if (document.querySelector("#testimonial-form")) {
  document.querySelector("#testimonial-form").addEventListener("submit", function (e) {
    ...
    scroll_into_view__WEBPACK_IMPORTED_MODULE_5___default()(document.querySelector(".form-step-container[data-testimonial-step='2']"));
  });
}
  ...
  var handleFiles = function handleFiles() {
    ...
    reader.onload = function (e) {
      ...
      testimonialCreateButton.addEventListener("click", function (e) {
        e.preventDefault();
        document.querySelector("#testimonial-loader-blind").classList.add("show");
                          ...
                          switch (_context.prev = _context.next) {
                            ...
                            case 5:
                              ...
                              if (content.status === "success") {
                                ...
                                document.querySelector("#testimonial-quote i").innerText = "\xAB".concat(testimonialdata.testimonial, "\xBB");
                                document.querySelector("#testimonial-name b").innerText = "".concat(testimonialdata.fname, " ").concat(testimonialdata.lname);
                                document.querySelector("#testimonial-position").innerText = testimonialdata.position;

                                if (testimonialdata.over18) {
                                  document.querySelector("#testimonial-slogan-1").innerText = "Meine Stimme";
                                  document.querySelector("#testimonial-slogan-2").innerText = "für deine Stimme";
                                } else {
                                  document.querySelector("#testimonial-slogan-1").innerText = "Deine Stimme";
                                  document.querySelector("#testimonial-slogan-2").innerText = "für meine Stimme";
                                }
                                ...
                                setTimeout(function () {
                                  document.querySelector("#testimonial-loader-blind").classList.remove("show");
                                }, 500);
                              }
...
if (document.querySelector("#testimonial-change-ds")) {
  document.querySelector("#testimonial-change-ds").addEventListener("click", function (e) {
    e.preventDefault();
    var ds = document.querySelector("body").getAttribute("data-ds");
    var dsNo = parseInt(ds.split("-")[1]);
    var newDs;

    if (dsNo === 5) {
      newDs = "ds-1";
    } else {
      newDs = "ds-".concat(dsNo + 1);
    }
...
if (document.querySelector("#testimonial-download")) {
  document.querySelector("#testimonial-download").addEventListener("click", function (e) {
    e.preventDefault();
    notyf.success({
      message: "Dein Testimonial wird gleich heruntergeladen. Bitte habe einen Moment Geduld :)",
      duration: 5000
    });

    if (document.querySelector(".testimonial-wrapper").getAttribute("data-browser") === "fuckusafari") {
      downloadSafari();
    } else {
      downloadRegular();
    }
...
function testimonialTest() {
  var testimonialdata = {
    uuid: (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(),
    testimonial_picture: "/wp-content/themes/sra16-zh/public/testimonials/image_624ebf9bcca1714.jpg",
    fname: "Timothy",
    lname: "Oesch",
    position: "Grafiker und Student",
    email: "timothy",
    over18: true,
    testimonial: "Ich sage ja zum Stimmrechtsalter 16, weil die Zukunft der Jugend gehören soll!",
    optin: true
  };
  document.getElementById("testimonial-form").remove();
  console.log(testimonialdata);
  document.getElementById("testimonial-img").src = testimonialdata.testimonial_picture;
  document.querySelector("#testimonial-quote i").innerText = "\xAB".concat(testimonialdata.testimonial, "\xBB");
  document.querySelector("#testimonial-name b").innerText = "".concat(testimonialdata.fname, " ").concat(testimonialdata.lname);
  document.querySelector("#testimonial-position").innerText = testimonialdata.position;
...
function downloadSafari() {
  (0,html_to_image__WEBPACK_IMPORTED_MODULE_6__.toCanvas)(document.getElementById("testimonial-container")).then(function (canvas) {
    var context = canvas.getContext("2d");
    var imageData = context.getImageData(0, 0, canvas.width, canvas.height);
    var test = pixelsAreWhite(imageData);
    var attempts = 0;
...
function downloadRegular() {
  (0,html_to_image__WEBPACK_IMPORTED_MODULE_6__.toJpeg)(document.getElementById("testimonial-container"), {
    quality: 1,
    pixelRatio: 4
  }).then(function (dataUrl) {
    var link = document.createElement("a");
    var name = document.querySelector("#testimonial-name b").innerText;
    link.download = "SRA16-testimonial-".concat(name, "-").concat((0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])(), ".jpg");
    link.href = dataUrl;
    link.click();
    link.remove();
  });
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[2]!./node_modules/notyf/notyf.min.css":
/*!****************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[2]!./node_modules/notyf/notyf.min.css ***!
  \****************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_8_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_8_oneOf_1_use_2_notyf_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../css-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[1]!../postcss-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[2]!./notyf.min.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[8].oneOf[1].use[2]!./node_modules/notyf/notyf.min.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_8_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_8_oneOf_1_use_2_notyf_min_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_8_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_8_oneOf_1_use_2_notyf_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
